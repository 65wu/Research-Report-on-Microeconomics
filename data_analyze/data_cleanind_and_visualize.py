...
# 选定comnum的列值大于10其小于1000的行
data0 = data[data['comnum']>20]
...
ax1.hist(data2['price'],pricesty,rwidth=0.8)
ax1.set_title('price')
#绘制评论数直方图
commentsty=np.arange(commentmin,commentmax,commentdst)
ax2.hist(data2['comnum'],commentsty,rwidth=0.8)
